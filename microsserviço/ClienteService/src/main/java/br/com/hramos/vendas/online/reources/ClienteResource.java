package br.com.hramos.vendas.online.reources;
...
import br.com.hramos.vendas.online.usecase.BuscaCliente;
import br.com.hramos.vendas.online.usecase.CadastroCliente;
...
public class ClienteResource {
	...
	public ResponseEntity<Cliente> buscarPorId(@PathVariable(required = true) String id) {
		return ResponseEntity.ok(buscaCliente.buscarPorId(id));
	}
	
	@GetMapping(value = "/isCadastrado/{id}")
	public ResponseEntity<Boolean> isCadastrado(@PathVariable(required = true) String id) {
	...
	public ResponseEntity<Cliente> buscarPorCpf(@PathVariable(required = true) Long cpf) {
	...
	public ResponseEntity<String> remover(@PathVariable(required = true) String id) {
